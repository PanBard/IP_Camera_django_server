...
def gen_frames():
    ...
    face_detected = False
    video = cv2.VideoCapture("rtsp://192.168.0.101:554/onvif/profile1/media.smp") # "rtsp://admin:<password>@192.168.8.166:554/onvif/profile1/media.smp" <-- for samsung camera
